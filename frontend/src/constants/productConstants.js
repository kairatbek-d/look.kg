...
export const INSTAGRAM_PRODUCT_REQUEST = 'INSTAGRAM_PRODUCT_REQUEST';
export const INSTAGRAM_PRODUCT_SUCCESS = 'INSTAGRAM_PRODUCT_SUCCESS';
export const INSTAGRAM_PRODUCT_FAIL = 'INSTAGRAM_PRODUCT_FAIL';
